// Screen data. Edit this file; index.html never changes.
window.__SCREEN__ = {
  names: [
    {
      t:"LSE: STEM", n:"SThree", type:"bid", mkt:"UK",
      px:"297.5p", cap:"£361m", rng:"137.2–324.0p", pos:86, adv:"—",
      date:"2026-10-07", when:"5.00pm, 7 Oct 2026",
      about:"Glasgow-founded STEM recruitment specialist placing contract and permanent staff in technology, engineering and life sciences across the UK, Germany, the Netherlands and the US. FTSE 250 until the cycle turned; revenue has been falling with the contract market. Approached on 9 Sep 2026 by Circle8 Group, a $43m Nasdaq-listed IT recruiter.",
      ev:"Rule 2.6(a) deadline — Circle8 must announce a firm offer or walk away",
      o:{asym:7,clarity:10,crowd:6,evid:9}, r:{liq:4,spof:8,down:5,slip:5},
      levels:[
        {k:"Undisturbed",v:"~276p",w:"Implied by the 15% pop to 317p on 9 Sep",c:"dn"},
        {k:"Now",v:"297.5p",w:"Roughly halfway to the spike high"},
        {k:"Offer-period high",v:"324.0p",w:"52-week high, set on the approach",c:"up"}
      ],
      implied:"At 297.5p the market prices something close to a coin flip on a firm offer — not a done deal. The asymmetry sits in the bidder: Circle8 is a $42.7m Nasdaq company proposing an all-cash acquisition of a £361m target, financed without issuing stock, with its own shares at $0.47 and down 38% over a year.",
      setup:"Unsolicited, preliminary and highly conditional approach on 9 Sep. The board rejected it unanimously on 11 Sep as significantly undervaluing the company. A Q3 trading update is due inside the offer period on 22 Sep.",
    ...
    {
      t:"NASDAQ: INO", n:"Inovio Pharmaceuticals", type:"reg", mkt:"US",
      px:"$1.24", cap:"$86m", rng:"$0.56–$2.72", pos:31, adv:"3.5m sh",
      date:"2026-10-30", when:"30 Oct 2026",
      ...
      ev:"PDUFA target action date — INO-3107 for recurrent respiratory papillomatosis",
      o:{asym:9,clarity:9,crowd:7,evid:5}, r:{liq:6,spof:10,down:9,slip:4},
      levels:[
        {k:"52-week low",v:"$0.56",w:"Where it traded before the run-in; the CRL case",c:"dn"},
        {k:"Now",v:"$1.24",w:"31% of the 52-week range"},
        {k:"52-week high",v:"$2.72",w:"Reached earlier in the review cycle",c:"up"}
      ],
    ...
    {
      t:"NASDAQ: CAPR", n:"Capricor Therapeutics", type:"clin", mkt:"US",
      px:"$9.08", cap:"$522m", rng:"$2.96–$40.37", pos:16, adv:"—",
      date:"2026-09-29", when:"29 Sep – 3 Oct 2026, then 22 Nov",
      ...
      ev:"24-month HOPE-3 data at World Muscle Society, then PDUFA on 22 Nov",
      o:{asym:8,clarity:8,crowd:8,evid:6}, r:{liq:5,spof:9,down:8,slip:6},
      levels:[
        {k:"52-week low",v:"$2.96",w:"The CRL case; reached after the AdCom vote",c:"dn"},
        {k:"Now",v:"$9.08",w:"16% of range, but +28% in a month"},
        {k:"52-week high",v:"$40.37",w:"Pre-AdCom, when approval looked routine",c:"up"}
      ],
    ...
    {
      t:"LSE: HWG", n:"Harworth Group", type:"bid", mkt:"UK",
      px:"178.6p", cap:"£581m", rng:"116.8–185.0p", pos:91, adv:"—",
      date:"2026-10-25", when:"1.00pm, 25 Oct 2026",
      ...
      ev:"Acceptance deadline on Peel's 177.5p Rule 9 mandatory offer",
      o:{asym:6,clarity:10,crowd:5,evid:10}, r:{liq:4,spof:7,down:6,slip:4},
      levels:[
        {k:"Pre-bid",v:"143.6p",w:"Close on 5 Aug, before the offer period",c:"dn"},
        {k:"Offer",v:"177.5p",w:"Cash on the table; stock trades above it"},
        {k:"EPRA NDV",v:"214.8p",w:"Published NAV at 30 Jun 2026",c:"up"}
      ],
    ...
    {
      t:"NASDAQ: COGT", n:"Cogent Biosciences", type:"reg", mkt:"US",
      px:"$32.08", cap:"$5.48bn", rng:"$11.60–$43.73", pos:64, adv:"2.2m sh",
      date:"2026-11-30", when:"30 Nov 2026, then 30 Dec",
      ...
      ev:"PDUFA for bezuclastinib in GIST, with a second decision a month later",
      o:{asym:6,clarity:9,crowd:5,evid:5}, r:{liq:3,spof:5,down:8,slip:4},
      levels:[
        {k:"52-week low",v:"$11.60",w:"Before the 152% twelve-month re-rate",c:"dn"},
        {k:"Now",v:"$32.08",w:"64% of range; −14% in the past month"},
        {k:"52-week high",v:"$43.73",w:"Set earlier in 2026",c:"up"}
      ],
    ...
    {
      t:"NASDAQ: PGEN", n:"Precigen", type:"reg", mkt:"US",
      px:"$7.77", cap:"$2.77bn", rng:"$2.99–$8.04", pos:95, adv:"4.9m sh",
      date:"2026-10-30", when:"30 Oct 2026",
      about:"Germantown, Maryland gene-and-cell-therapy company whose Papzimeos, approved in August 2025, is the first FDA-approved treatment for recurrent respiratory papillomatosis. The stock has doubled in a year on the launch. Its only near-term competitor is Inovio's INO-3107, decided on 30 Oct.",
      ev:"Inovio's PDUFA — the read-across to the incumbent",
      o:{asym:4,clarity:8,crowd:1,evid:6}, r:{liq:3,spof:6,down:9,slip:4},
      levels:[
        {k:"52-week low",v:"$2.99",w:"Before the Papzimeos commercial ramp",c:"dn"},
        {k:"Now",v:"$7.77",w:"95% of the 52-week range"},
        {k:"52-week high",v:"$8.04",w:"Essentially where it trades",c:"up"}
      ],
      implied:"Sitting at 95% of its 52-week range, up 104% over a year and 61% over three months, on the strength of Papzimeos being the only approved RRP therapy. That monopoly has a dated expiry risk: Inovio's decision on 30 October. The price does not appear to reflect a competitor arriving in six weeks.",
      setup:"Papzimeos was approved in August 2025 as the first and only FDA-approved therapy for recurrent respiratory papillomatosis. Inovio's INO-3107 targets the same indication with a simpler regimen — no additional surgery before later doses.",
    ...
    {
      t:"LSE: ELCO", n:"Eleco", type:"bid", mkt:"UK",
      px:"229.36p", cap:"£191m", rng:"101.0–231.0p", pos:99, adv:"191k sh",
      date:"2026-12-31", when:"Scheme timetable, into 2027",
      ...
      ev:"Court-sanctioned scheme on Accel-KKR's 235p cash offer",
      o:{asym:2,clarity:5,crowd:3,evid:10}, r:{liq:6,spof:3,down:7,slip:7},
      levels:[
        {k:"Pre-bid",v:"~135p",w:"Before the 70% single-day move",c:"dn"},
        {k:"Now",v:"229.36p",w:"2.5% below terms"},
        {k:"Offer",v:"235p",w:"Accel-KKR cash, recommended",c:"up"}
      ],
    ...
    {
      t:"LSE: SPI", n:"Spire Healthcare", type:"bid", mkt:"UK",
      px:"245.5p", cap:"£983m", rng:"140.8–256.5p", pos:90, adv:"2.3m sh",
      date:"2026-11-30", when:"Offer ongoing — no fixed close",
      ...
      ev:"Toscafund-led 250p offer, under a Takeover Panel restriction",
      o:{asym:2,clarity:4,crowd:3,evid:10}, r:{liq:3,spof:4,down:7,slip:8},
      levels:[
        {k:"52-week low",v:"140.8p",w:"The no-deal case",c:"dn"},
        {k:"Now",v:"245.5p",w:"1.8% below the offer"},
        {k:"Offer",v:"250p",w:"Values equity at £1.03bn, EV £2.31bn",c:"up"}
      ],
    ...
    {
      t:"NASDAQ: PCVX", n:"Vaxcyte", type:"clin", mkt:"US",
      px:"$58.95", cap:"$8.51bn", rng:"$30.89–$65.00", pos:82, adv:"—",
      date:"2026-10-31", when:"By end of October 2026",
      about:"San Carlos, California vaccine company developing VAX-31, a 31-valent pneumococcal conjugate vaccine intended to beat Prevnar 20 and Capvaxive on coverage. No approved product; $8.5bn market cap rests on a three-trial adult Phase 3 programme that is fully enrolled.",
      ev:"VAX-31 adult Phase 3 OPUS-1 topline safety and immunogenicity",
      o:{asym:4,clarity:6,crowd:2,evid:5}, r:{liq:2,spof:8,down:9,slip:7},
      levels:[
        {k:"52-week low",v:"$30.89",w:"The failed-readout reference",c:"dn"},
        {k:"Now",v:"$58.95",w:"82% of the 52-week range"},
        {k:"52-week high",v:"$65.00",w:"Set on the run into the readout",c:"up"}
      ],
      implied:"An $8.5bn valuation on a company with no approved product, 82% of the way up its range and 81% higher over a year. This is a binary priced for success — the mirror image of Capricor. The question isn't direction, it's what's left on the upside if the trial does exactly what everyone expects.",
      setup:"Guidance narrowed on 3 Sep from Q4 to 'by the end of October'. OPUS-1 is the pivotal non-inferiority trial in a three-study adult programme with 6,191 adults dosed, roughly 3,500 on VAX-31, designed in consultation with the FDA.",
    ...
    {
      t:"NASDAQ: MRNA", n:"Moderna", type:"clin", mkt:"US",
      px:"$155.43", cap:"$61.7bn", rng:"$22.28–$176.66", pos:86, adv:"13.5m sh",
      date:"2026-10-23", when:"23–27 Oct 2026, ESMO Madrid",
      ...
      ev:"Full intismeran autogene dataset, with a Phase 3 melanoma interim in H2",
      o:{asym:3,clarity:7,crowd:1,evid:5}, r:{liq:1,spof:6,down:10,slip:5},
      levels:[
        {k:"52-week low",v:"$22.28",w:"Where it started this run",c:"dn"},
        {k:"Now",v:"$155.43",w:"+427% YTD, +147% in one month"},
        {k:"52-week high",v:"$176.66",w:"Set this month",c:"up"}
      ],
    ...
    {
      t:"NASDAQ: IVVD", n:"Invivyd", type:"clin", mkt:"US",
      px:"$0.74", cap:"$218m", rng:"$0.53–$3.07", pos:8, adv:"4.4m sh",
      date:"2026-09-30", when:"Later in Q3 2026 (guided), i.e. by 30 Sep",
      ...
      ev:"DECLARATION pivotal Phase 3 topline for VYD2311 — COVID-19 prophylaxis in vulnerable adults",
      o:{asym:9,clarity:7,crowd:9,evid:4}, r:{liq:5,spof:10,down:10,slip:6},
      levels:[
        {k:"52-week low",v:"$0.53",w:"Set this summer; the failed-trial reference",c:"dn"},
        {k:"Now",v:"$0.74",w:"8% of the 52-week range; −70% YTD"},
        {k:"52-week high",v:"$3.07",w:"Before the Pemgarda revenue disappointment",c:"up"}
      ],
    ...
    {
      t:"NASDAQ: SVRA", n:"Savara", type:"reg", mkt:"US",
      px:"$5.39", cap:"$1.10bn", rng:"$3.34–$7.01", pos:56, adv:"1.7m sh",
      date:"2026-11-22", when:"22 Nov 2026",
      ...
      ev:"PDUFA target action date — MOLBREEVI in autoimmune PAP",
      o:{asym:6,clarity:10,crowd:7,evid:5}, r:{liq:3,spof:10,down:8,slip:4},
      levels:[
        {k:"52-week low",v:"$3.34",w:"The CRL case",c:"dn"},
        {k:"Now",v:"$5.39",w:"56% of range; flat over one and three months"},
        {k:"52-week high",v:"$7.01",w:"Set on the BLA acceptance",c:"up"}
      ],
    ...
    {
      t:"NASDAQ: SMMT", n:"Summit Therapeutics", type:"reg", mkt:"US",
      px:"$17.53", cap:"$14.0bn", rng:"$12.07–$29.23", pos:32, adv:"5.3m sh",
      date:"2026-11-14", when:"14 Nov 2026",
      ...
      ev:"PDUFA target action date — ivonescimab BLA in EGFR-mutant NSCLC after a third-generation TKI",
      o:{asym:6,clarity:10,crowd:5,evid:5}, r:{liq:1,spof:7,down:6,slip:4},
      levels:[
        {k:"52-week low",v:"$12.07",w:"Set on the HARMONi OS miss in 2025",c:"dn"},
        {k:"Now",v:"$17.53",w:"32% of range; +37% in one month"},
        {k:"52-week high",v:"$29.23",w:"Set on the initial HARMONi-2 read-across",c:"up"}
      ],
    ...
    {
      t:"NASDAQ: MIRM", n:"Mirum Pharmaceuticals", type:"reg", mkt:"US",
      px:"$94.48", cap:"$5.76bn", rng:"$63.23–$130.00", pos:47, adv:"847k sh",
      date:"2026-09-26", when:"26 Sep 2026, then AZURE-1 by 30 Sep",
      ...
      ev:"PDUFA for zilurgisertib in fibrodysplasia ossificans progressiva on 26 Sep, then Phase 3 AZURE-1 topline for brelovitug in hepatitis delta by month-end",
      o:{asym:5,clarity:9,crowd:7,evid:5}, r:{liq:2,spof:4,down:4,slip:4},
      levels:[
        {k:"52-week low",v:"$63.23",w:"Set before the LIVMARLI growth re-rate",c:"dn"},
        {k:"Now",v:"$94.48",w:"47% of range; −8% in five days into the events"},
        {k:"52-week high",v:"$130.00",w:"Set earlier in 2026",c:"up"}
      ],
    ...
    {
      t:"NASDAQ: KOD", n:"Kodiak Sciences", type:"clin", mkt:"US",
      px:"$31.64", cap:"$1.98bn", rng:"$9.39–$47.84", pos:58, adv:"685k sh",
      date:"2026-09-30", when:"September 2026 (guided)",
      ...
      ev:"Phase 3 DAYBREAK one-year topline — Zenkuda and KSI-501 versus aflibercept in treatment-naive wet AMD",
      o:{asym:7,clarity:7,crowd:6,evid:4}, r:{liq:3,spof:8,down:9,slip:5},
      levels:[
        {k:"52-week low",v:"$9.39",w:"Before the 2025–26 re-rate; where a failed DAYBREAK would be argued",c:"dn"},
        {k:"Now",v:"$31.64",w:"58% of range; −22% in the past month"},
        {k:"52-week high",v:"$47.84",w:"Set in the summer run-up",c:"up"}
      ],
    ...
    {
      t:"NASDAQ: BBIO", n:"BridgeBio Pharma", type:"reg", mkt:"US",
      px:"$67.06", cap:"$13.1bn", rng:"$48.78–$93.42", pos:41, adv:"3.0m sh",
      date:"2026-11-27", when:"27 Nov 2026",
      about:"Palo Alto genetic-disease company with one commercial product, Attruby (acoramidis) for ATTR cardiomyopathy, approved in the US, EU, Japan and UK, and a sequence of late-stage rare-disease filings behind it. Roughly 1,000 staff and a $13bn market cap; the events are a pipeline sequence, not a single bet.",
      ev:"PDUFA target action date — BBP-418 in limb-girdle muscular dystrophy type 2I/R9 (priority review)",
      o:{asym:5,clarity:10,crowd:7,evid:5}, r:{liq:1,spof:3,down:4,slip:3},
      levels:[
        {k:"52-week low",v:"$48.78",w:"Pre-Attruby launch traction",c:"dn"},
        {k:"Now",v:"$67.06",w:"41% of range; −19% in the past month"},
        {k:"52-week high",v:"$93.42",w:"Set on Attruby launch momentum",c:"up"}
      ],
      implied:"Down 19% in a month and 12% year to date on a company whose lead product is launched and growing, with a priority-review PDUFA ten weeks out. The price is reacting to sector flows and a Q2 guidance debate, not to the LGMD decision, which means the decision is close to free at the current level.",
      setup:"BBP-418 NDA accepted with priority review and a PDUFA date of 27 Nov 2026 for LGMD2I/R9, a disease with no approved therapy. Encaleret in ADH1 follows on 8 May 2027, and infigratinib in achondroplasia is awaiting a filing decision. Attruby sales are the base under all of it.",
    ...
    {
      t:"STO: EGTX", n:"Egetis Therapeutics", type:"reg", mkt:"SE",
      px:"SEK 7.91", cap:"SEK 3.7bn", rng:"SEK 3.63–8.30", pos:92, adv:"747k sh",
      date:"2026-09-28", when:"28 Sep 2026",
      about:"Stockholm-listed orphan-drug company. Emcitate (tiratricol) is the first and only approved treatment for MCT8 deficiency in the EU, launched in Germany in May 2025, with Q2 sales of SEK 17m. US NDA under priority review; a US launch, a rare-disease priority review voucher sale and a European rollout are the whole investment case. 56 staff.",
      ev:"PDUFA target action date — Emcitate (tiratricol) NDA in MCT8 deficiency",
      o:{asym:3,clarity:10,crowd:1,evid:6}, r:{liq:5,spof:10,down:9,slip:3},
      levels:[
        {k:"52-week low",v:"SEK 3.63",w:"Before the NDA acceptance; the CRL case",c:"dn"},
        {k:"Now",v:"SEK 7.91",w:"92% of range; +50% in three months"},
        {k:"52-week high",v:"SEK 8.30",w:"Set this month, into the date",c:"up"}
      ],
      implied:"Up 50% in three months to 92% of its range ten days before the decision. The market has priced approval; the late-cycle meeting and label negotiations that management referenced on 16 Sep are consistent with that. What is left is the difference between an approval and an approval-plus-voucher, against a 54% drop to the low if the agency surprises.",
      setup:"NDA accepted with priority review in March; PDUFA date 28 Sep 2026. FDA confirmed it expects to complete the review on time and does not plan an advisory committee. Management said on 16 Sep that label negotiations are under way. A SEK 350m placing in June funds the US launch.",
    ...
    {
      t:"NASDAQ: PYPD", n:"PolyPid", type:"reg", mkt:"IL",
      px:"$5.21", cap:"$99m", rng:"$3.06–$5.73", pos:80, adv:"193k sh",
      date:"2026-11-28", when:"28 Nov 2026",
      about:"Petah Tikva, Israel drug-delivery company. D-PLEX100 is a polymer-lipid matrix placed in the surgical wound that releases antibiotic locally for weeks, aimed at preventing surgical site infection after colorectal surgery. NDA under priority review; US and Canada commercial rights licensed to Azurity in July for $30m of upfront and near-term milestones. $99m market cap.",
      ev:"PDUFA target action date — D-PLEX100 NDA in abdominal colorectal surgery (priority review)",
      o:{asym:4,clarity:10,crowd:3,evid:4}, r:{liq:8,spof:10,down:9,slip:4},
      levels:[
        {k:"52-week low",v:"$3.06",w:"Before the SHIELD II data and the Azurity deal",c:"dn"},
        {k:"Now",v:"$5.21",w:"80% of range; bid–ask $5.14/$5.25"},
        {k:"52-week high",v:"$5.73",w:"Set on the NDA acceptance",c:"up"}
      ],
      implied:"A $99m company with a priority-review PDUFA that the FDA accepted one quarter ahead of the company's own guidance with no filing issues. At 80% of range the market has moved toward approval but the absolute size means the reference levels understate the move: the 52-week high is only 10% above the price, which tells you how little the stock has been allowed to discount a launch.",
      setup:"NDA accepted 27 Jul 2026 with priority review and a PDUFA date of 28 Nov 2026, ahead of the Q1 2027 guidance. Acceptance triggered a $15m milestone from Azurity, completing $30m of upfront and near-term payments. EMA MAA submission planned for Q3 2026.",
    ...
    {
      t:"LSE: EZJ", n:"easyJet", type:"bid", mkt:"UK",
      px:"667.4p", cap:"£4.99bn", rng:"332.6–683.8p", pos:95, adv:"7.5m sh",
      date:"2026-10-15", when:"Scheme document by 15 Oct; Court Meeting w/c 9 Nov",
      about:"Luton-based low-cost airline, Europe's second largest by passengers, with around 300 aircraft and a holidays business. Agreed on 6 Aug 2026 to a recommended £5.7bn cash acquisition by Apollo funds at 715p per share, after seeing off Castlelake. Rejoins the FTSE 100 on 21 Sep, probably briefly.",
      ev:"Scheme document publication, then Court Meeting and General Meeting on Apollo's 715p recommended offer",
      o:{asym:4,clarity:8,crowd:4,evid:10}, r:{liq:1,spof:6,down:8,slip:7},
      levels:[
        {k:"Undisturbed",v:"~395p",w:"Back-solved from the stated 81% premium to the May 2026 price",c:"dn"},
        {k:"Now",v:"667.4p",w:"6.7% below the cash offer"},
        {k:"Offer",v:"715p",w:"Apollo cash, recommended; rollover alternative for holders who want to stay in",c:"up"}
      ],
      implied:"A 6.7% gross spread on a recommended, financed, board-and-founder-backed cash offer is far wider than a clean UK scheme normally trades. The market is charging for one specific thing: EU rules require an airline to be majority owned and effectively controlled by EU nationals, and Apollo is American. The scheme document was delayed to 15 Oct explicitly to keep talking to aviation regulators. The spread is the price of that structure being accepted.",
      setup:"Apollo's Eagle Bidco agreed a 715p cash offer on 6 Aug with a rollover alternative; the Haji-Ioannou family (15%) has agreed to vote in favour and roll. On 25 Aug both sides extended the scheme document deadline from 3 Sep to 15 Oct to continue engagement with aviation regulators. Court Meeting and General Meeting expected in the week of 9 Nov; completion still guided by end of Q1 2027.",
    ...
    {
      t:"LSE: BOY", n:"Bodycote", type:"bid", mkt:"UK",
      px:"953.5p", cap:"£1.62bn", rng:"585.0–967.5p", pos:96, adv:"737k sh",
      date:"2026-09-29", when:"Scheme document by 29 Sep; CVC to clarify by Day 53",
      about:"Macclesfield, England — the world's largest heat-treatment and thermal-processing group, around 130 plants in 22 countries serving aerospace, defence, automotive and energy. After approaches from Apollo, CVC and Veritas since May, the board recommended Veritas Capital's 940p cash offer on 1 Sep 2026. CVC, which had bid 915p, says it is reviewing its position.",
      ev:"Scheme document on Veritas's 940p recommended offer; CVC must declare whether it will counter",
      o:{asym:3,clarity:8,crowd:3,evid:10}, r:{liq:3,spof:5,down:7,slip:5},
      levels:[
        {k:"Undisturbed",v:"~684p",w:"Back-solved from the 37.5% premium to the 3-month VWAP to 21 May",c:"dn"},
        {k:"Offer",v:"940p",w:"Veritas cash, including the 7.2p interim dividend; recommended"},
        {k:"Now",v:"953.5p",w:"1.4% above the offer — the market is paying for a counterbid"}
      ],
      implied:"The stock trades above a recommended cash offer, so the market is not pricing the deal on the table; it is pricing CVC. Three bidders have now put numbers on this company within four months, and CVC's last proposal was 915p before Veritas went to 940p. The 13.5p above terms is the market's price for CVC coming back at, say, 975p or more.",
      setup:"Veritas's Vulcan Alpha Bidco announced a Rule 2.7 firm offer at 940p on 1 Sep after Bodycote ran a parallel process with CVC and Veritas. Apollo had withdrawn a £1.52bn proposal in June. The buyback was suspended on 2 Sep. Scheme document due within 28 days; a named competing bidder must clarify its intentions by Day 53 of the timetable.",
      bull:"A genuine auction with a US aerospace-and-defence specialist as the incumbent and a large European buyout firm that has already bid once. CVC needs only to clear 940p by a margin the board can recommend.",
      bear:"If CVC walks, the stock settles back to the offer and you have paid 1.4% for nothing, over a timetable to Q1 2027. A break of the Veritas deal itself is a 28% fall to the undisturbed level.",
      kill:"A CVC statement under Rule 2.8 that it does not intend to bid, or the scheme document arriving with irrevocables from a large enough block to make a counterbid impractical.",
      angle:"Trading above terms is a specific claim: the market believes the auction is not over. Say what the 13.5p premium implies about the probability-weighted counterbid and you have shown you can read a price, not just a headline."
    },
    {
      t:"LSE: GAMA", n:"Gamma Communications", type:"bid", mkt:"UK",
      px:"1,125p", cap:"£1.01bn", rng:"687–1,207p", pos:84, adv:"779k sh",
      date:"2026-09-29", when:"Scheme document by 29 Sep; Waterland's position to be clarified",
      ...
      ev:"Scheme document on Epiris's 1,120p recommended offer; the market is waiting on Waterland",
      o:{asym:3,clarity:8,crowd:4,evid:10}, r:{liq:3,spof:5,down:8,slip:5},
      levels:[
        {k:"Undisturbed",v:"732p",w:"Close on 7 Apr 2026, before the offer period began",c:"dn"},
        {k:"Offer",v:"1,120p",w:"Epiris cash, recommended; 53% premium"},
        {k:"Now",v:"1,125p",w:"0.4% above terms"}
      ],
    ...
    {
      t:"LSE: CNE", n:"Capricorn Energy", type:"bid", mkt:"UK",
      px:"382p", cap:"£262m", rng:"181.8–390p", pos:96, adv:"176k sh",
      date:"2026-09-29", when:"Scheme document by 29 Sep",
      ...
      ev:"DNO scheme document; Genel's rival scheme has not formally lapsed",
      o:{asym:2,clarity:8,crowd:3,evid:10}, r:{liq:6,spof:5,down:7,slip:5},
      levels:[
        {k:"Undisturbed",v:"266p",w:"Close on 10 Mar 2026, before the offer period",c:"dn"},
        {k:"Now",v:"382p",w:"1.6% below the DNO offer in sterling"},
        {k:"DNO offer",v:"~388p",w:"$5.214 all-cash, recommended; sterling election available",c:"up"}
      ],
    ...
    {
      t:"NYSE: RGR", n:"Sturm, Ruger & Co.", type:"bid", mkt:"US",
      px:"$40.29", cap:"$644m", rng:"$28.33–$48.21", pos:60, adv:"127k sh",
      date:"2026-10-15", when:"11.59pm New York, 15 Oct 2026",
      about:"Southport, Connecticut firearms manufacturer — Ruger and Marlin rifles, pistols and revolvers, plus a castings business — with no debt and a long dividend history. Beretta Holding of Luxembourg flagged interest in March and on 17 Sep 2026 launched a partial cash tender for up to 2,400,184 shares at $44.80. Existing shareholders keep the rest of their position.",
      ev:"Beretta partial tender offer for ~15% of the shares at $44.80 expires",
      o:{asym:4,clarity:10,crowd:6,evid:9}, r:{liq:6,spof:4,down:4,slip:3},
      levels:[
        {k:"Pre-tender close",v:"~$37.0",w:"16 Sep 2026, back-solved from the stated 21% premium",c:"dn"},
        {k:"Now",v:"$40.29",w:"60% of range; +6% in five days"},
        {k:"Tender price",v:"$44.80",w:"Cash, for up to 2.4m shares only — tenders are prorated",c:"up"}
      ],
      implied:"A partial tender is a different instrument from a takeover: the $44.80 is real, but only for the fraction of your shares that gets accepted. If every holder tenders, roughly one share in seven is taken at $44.80 and the rest stay in a stock that was $37 a fortnight ago. The price at $40.29 is the blend — the market is pricing a moderate acceptance rate plus a strategic holder arriving on the register.",
      setup:"Beretta Holding commenced the tender on 17 Sep at $44.80, a 21% premium to the prior close and 20% to the 60-day VWAP before its March announcement. No financing condition and no minimum tender condition. Expires one minute after 11.59pm New York time on 15 Oct unless extended.",
    ...
    {
      t:"ASX: RWC", n:"Reliance Worldwide", type:"bid", mkt:"AU",
      px:"A$4.59", cap:"A$3.43bn", rng:"A$2.86–4.65", pos:97, adv:"4.0m sh",
      date:"2026-10-16", when:"Go-shop period ends 16 Oct 2026",
      about:"ASX-listed, Atlanta-run plumbing products group behind SharkBite push-to-connect fittings, John Guest, Cash Acme and Holman. Most profit comes from North America, where tariffs and lower volumes cut adjusted operating profit by over 11% in FY26. Agreed on 16 Sep 2026 to a Brookfield scheme at US$3.38 a share after four approaches since April.",
      ev:"End of the unusual 'go-shop' window in which the board may solicit a superior proposal to Brookfield's",
      o:{asym:3,clarity:9,crowd:3,evid:9}, r:{liq:2,spof:5,down:7,slip:4},
      levels:[
        {k:"Pre-approach",v:"~A$3.32",w:"Back-solved from the stated 43% premium to the six-month VWAP",c:"dn"},
        {k:"Now",v:"A$4.59",w:"97% of range; +8% in five days"},
        {k:"Offer",v:"US$3.38 ≈ A$4.75",w:"Brookfield cash, recommended; the AUD value floats with the exchange rate",c:"up"}
      ],
      implied:"About 3.5% below an offer denominated in US dollars, on a timetable to Q1 2027, with a go-shop that ends on 16 Oct. The spread is the market's blend of currency risk, scheme execution and a small probability that the go-shop produces a rival. Brookfield holds matching rights, which caps how much a rival can win by and therefore how much the go-shop is worth.",
      setup:"Brookfield Capital Partners made proposals at A$4.15, A$4.25 and A$4.50 before a fourth in August at US$3.38 (A$4.75 at the time). Scheme implementation deed signed 16 Sep with a go-shop to 16 Oct, a US$25.3m break fee and a reverse break fee on the same terms. Shareholder vote and court approval to follow; completion guided for Q1 2027.",
    ...
    {
      t:"NYSE: NATL", n:"NCR Atleos", type:"reg", mkt:"US",
      px:"$45.66", cap:"$3.37bn", rng:"$33.31–$48.50", pos:81, adv:"722k sh",
      date:"2026-10-22", when:"CMA Phase 1 decision by 22 Oct 2026",
      about:"Atlanta-based ATM manufacturer, operator and services company spun out of NCR in 2023, including the Allpoint surcharge-free ATM network. Agreed in February 2026 to be acquired by Brink's for $30 cash plus 0.1574 Brink's shares per NATL share, about $6.6bn including debt. Shareholders of both companies approved on 30 Jun; US, Brazil and India clearances are in hand.",
      ev:"UK CMA Phase 1 decision on the Brink's acquisition — clearance, or a reference to Phase 2",
      o:{asym:2,clarity:10,crowd:4,evid:9}, r:{liq:2,spof:5,down:5,slip:3},
      levels:[
        {k:"Pre-announcement",v:"~$40.6",w:"25 Feb 2026, back-solved from the stated 24% premium",c:"dn"},
        {k:"Now",v:"$45.66",w:"2.2% below the current value of the consideration"},
        {k:"Consideration",v:"$46.67",w:"$30 cash + 0.1574 × Brink's at $105.89; moves with BCO",c:"up"}
      ],
      implied:"A 2.2% spread with one regulatory gate left that has a date on it. The CMA opened Phase 1 on 26 Aug and must decide by 22 Oct; both companies have UK cash-handling and ATM businesses, so a remedy discussion is plausible even if a Phase 2 reference is not. The stock leg of the consideration means the spread has been drifting with Brink's, which is down 4% in five days.",
      setup:"Brink's agreed to buy NCR Atleos on 26 Feb 2026 for $30 cash and 0.1574 Brink's shares per share, funded with cash and a $4.5bn Morgan Stanley bridge. Shareholder approvals were obtained 30 Jun; HSR, Brazil and India have cleared. The CMA's Phase 1 deadline is 22 Oct; completion is guided for early Q1 2027.",
  ...
  watch: [
    {d:"2026-10-04", t:"Merck — WELIREG plus Lenvima PDUFA", s:"First of three label events opening Merck's Q4; too large for the move to matter to a satellite sleeve."},
    {d:"2026-10-10", t:"Merck — ifinatamab deruxtecan PDUFA", s:"Second dated decision inside a week."},
    {d:"2026-10-15", t:"Roche — Enspryng in thyroid eye disease", s:"Priority review decision. Roche is the wrong size to trade on it; the read-across to TED competitors is the angle."},
    {d:"2026-11-11", t:"CMA phase 1 — McCormick / Unilever foods", s:"A phase 2 reference is the tail risk. The expression is the spread rather than either equity."},
    {d:"2026-11-30", t:"Regeneron — cemdisiran in generalised myasthenia gravis", s:"Priority review following a voucher. Large-cap, single-product-line impact."},
    {d:"2026-09-22", t:"Ionis — zilganersen PDUFA in Alexander disease", s:"A rare-disease decision on a $7bn company; the label matters more than the stock move."},
    {d:"2026-10-01", t:"ACV Auctions — Copart's $10.50 cash tender expires", s:"No financing condition, no minimum. The spread is too thin to score; it is here as the arb control case alongside Eleco."},
    {d:"2026-10-02", t:"Elmera Group — Fortum's NOK 47 tender expires (extended)", s:"86.4% accepted against a 90% condition. No timestamped price this run, so dated rather than scored; the only question is whether the last 3.6% arrives."},
    {d:"2026-10-20", t:"Gilead — lenacapavir PDUFA in HIV prevention (new regimen)", s:"Too large to move on it; the read-across is to the long-acting PrEP competitors."},
  ]
};
